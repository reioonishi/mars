...
import com.opensymphony.xwork2.ActionSupport;
	...
	public class CreateUserConfirmAction extends ActionSupport implements SessionAware {
		...
		private List<String> userIdExistErrorMessageList = new ArrayList<String>();
		...
		public String execute() {
			...
			passwordErrorMessageList = inputChecker.doCheck("パスワード", password, 1, 16, true, false, false, true, false, false, false);
					...
					if(familyNameErrorMessageList.size()==0
						...
						if(userInfoDao.isExistsUserInfo(userId)){
							userIdExistErrorMessageList.add("使用できないユーザーIDです。");
							session.put("UserIdExistErrorMessageList", userIdExistErrorMessageList);
				}else{
					result = SUCCESS;
				}
			...
			session.put("IdErrorMessageList", userIdErrorMessageList);
		...
		public void setSexList(List<String> sexList) {//リターンの後ろの値を呼び出し元に返す
			this.sexList = sexList;			//voidは何も戻さない ※voidは何もない・thisは自分自身のインスタンス化
		}
		...
		public List<String> getUserIdExistErrorMessageList() {
			return userIdExistErrorMessageList;
		}
		public void setUserIdExistErrorMessageList(List<String> userIdExistErrorMessageList) {
			this.userIdExistErrorMessageList = userIdExistErrorMessageList;
		}
		public void setUserIdErrorMessageList(List<String> userIdErrorMessageList) {
			this.userIdErrorMessageList = userIdErrorMessageList;
		}
